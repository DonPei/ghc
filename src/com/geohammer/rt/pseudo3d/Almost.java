...
public class Almost implements Serializable, Comparator<Number> {
   ...
   public Almost(final boolean isDouble) {
       if (isDouble) {
           epsilon = 10.0 * DBL_EPSILON;
           minValue = 100.0 * Double.MIN_VALUE;
   ...
   public boolean equals(final Object object) {
       ...
       return epsilon == other.epsilon && minValue == other.minValue;
   }

   // Object
   @Override
   public int hashCode() {
       return Long.valueOf(Double.doubleToLongBits(epsilon) ^
               Double.doubleToLongBits(minValue)).intValue();
   }

   // Object
   @Override
   public String toString() {
       return "Almost<eps=" + epsilon + ",min=" + minValue + ">";
   }
}
