 ...
 * @version 2005.09.27
 */
public class TransparentPixelsView extends TiledView implements ColorMapped {
   ...
   */
  public TransparentPixelsView(float[][] f) {
    this(new float[][][]{f});
  }
   ...
   * @param f array[n2][n1] of sampled function values f(x1,x2).
   */
  public TransparentPixelsView(Sampling s1, Sampling s2, float[][] f) {
  ...
  public Dimension stringSize(String str, Graphics g) {
  ...
  public void paint(Graphics2D g2d) {
    ...
    if (_nc==1) {
      ...
      BufferedImage rbi = rescale(bi, 0.5f, 0.0f);
      // Create a rescale filter op that makes the image 50% opaque.
      g2d.drawImage(rbi,xc,yc,null);
      ...
      Dimension c = stringSize(_label, g2d);
      
      g2d.drawString(_label, 15, (int)(3+c.getHeight()));
    }
  ...
  public static IndexColorModel rescale(IndexColorModel icm, float scaleFactor, float offset) {
      ...
      rescale(alphas, scaleFactor, offset);
