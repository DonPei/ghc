...
public class ScatterPlotDialog extends CommonDialog {
	...
	public ScatterPlotDialog(JFrame aParent, String aTitle, boolean modal, DipLayer1D dipLayer1D,
	...
	public ScatterPlotDialog(int nRow, int nCol, JFrame aParent, String aTitle, boolean modal, DipLayer1D dipLayer1D,
			int iType, boolean isDepthPlot, String catalog, String hLabel, String vLabel) {
	...
	private float[][] toFloatArrays(double [][] v) {
		float [][] t = new float[v.length][];
		for(int i=0; i<v.length; i++) {
			float [] a = new float[v[i].length];
	...
	public void setCurves(double [][] curves) 	{ _curves = toFloatArrays(curves); }
