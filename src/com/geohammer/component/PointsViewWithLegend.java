...
public class PointsViewWithLegend extends TiledView {
	 ...
	 */
	public PointsViewWithLegend(float[] x2) {
	 ...
	 * @param x2 array of x2 coordinates.
	 */
	public PointsViewWithLegend(Sampling s1, float[] x2) {
		set(s1,x2);
	}
	 ...
	 * @param x2 array of x2 coordinates.
	 */
	public PointsViewWithLegend(float[] x1, float[] x2) {
		set(x1,x2);
	}
	 ...
	 */
	public PointsViewWithLegend(float[] x1, float[] x2, float[] x3) {
		set(x1,x2,x3);
	}
