...
package com.geohammer.complex;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import com.geohammer.complex.FieldElement;
import com.geohammer.complex.exception.LocalizedFormats;
import com.geohammer.complex.exception.NotPositiveException;
import com.geohammer.complex.exception.NullArgumentException;
 ...
 * {@link org.org.ucdm.complex.Precision#equals(double,double,int)
 * equals for primitive double} in {@link org.org.ucdm.complex.Precision}
...
public class Complex implements FieldElement<Complex>, Serializable  {
    ...
    public void set(double factor, Complex other) {
    	this.real = factor*other.getReal();
        this.imaginary = factor*other.getImaginary();
    }
    ...
    public void multiply(double [] realImg, Complex factor){
    	realImg[0] = real * factor.real - imaginary * factor.imaginary;
    	realImg[1] = real * factor.imaginary + imaginary * factor.real;
    }
    public void divide(double [] realImg, Complex divisor) {
            ...
            if (FastMath.abs(c) < FastMath.abs(d)) {
                ...
                realImg[0] = (real * q + imaginary) / denominator;
                realImg[1] = (imaginary * q - real) / denominator;
            } else {
                double q = d / c;
                double denominator = d * q + c;
                realImg[0] = (imaginary * q + real) / denominator;
                realImg[1] = (imaginary - real * q) / denominator;
            }
        }
    /**
     ...
     */
    public Complex divide1(Complex divisor)
     ...
     */
    public Complex multiply1(Complex factor)
        throws NullArgumentException {
